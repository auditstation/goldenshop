...
class PurchaseGoldInfo(models.Model):
    ...
    price_unit_iqd = fields.Monetary(related='po_line.price_unit_iqd',currency_field="currency_id_iqd",store=True)
    ...
    price_unit_usd = fields.Monetary(related='po_line.price_unit_usd',currency_field="currency_id_usd",store=True)
